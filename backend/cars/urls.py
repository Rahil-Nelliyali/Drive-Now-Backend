...
from .views import CarCategoryListCreateView, CarSlotsListView,CarListCreateView, SingleCarSlotDetailView,SingleCarDetailView,HomeListCar,HomeListLocation, CarDeleteView, CarUpdateView, CreateCar, CreateCarCategory, CategoryDeleteView, CategoryUpdateView, ApproveCar, RejectCar, BlockCar, MyCars
from . import views
...
urlpatterns = [
    ...
    path('home-list-locations/', HomeListLocation.as_view(), name='home-list-locations'),
