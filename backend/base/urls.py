...
from . import views
from . views import AuthView,UserRegistration,Listuser,GetProfile,UpdateProfile,ChangePass,ChangeImage,BlockUserView, RenterRegistration, Listrenter, BlockRenterView
...
urlpatterns = [
    ...
    path('activaterenter/<uidb64>/<token>',views.activaterenter, name='activaterenter'),
