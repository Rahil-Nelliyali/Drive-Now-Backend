...
class CarBooking(models.Model):
    ...
    late_return_charges = models.DecimalField(
        max_digits=10, decimal_places=2, default=0
    )
    damage_charges = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    pickup_location = models.ForeignKey(
        Location, related_name="pickup_bookings", on_delete=models.SET_NULL, null=True
    )
    dropoff_location = models.ForeignKey(
        Location, related_name="dropoff_bookings", on_delete=models.SET_NULL, null=True
    )
